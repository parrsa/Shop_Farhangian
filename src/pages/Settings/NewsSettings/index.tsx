        ...
        <SettingLayout>
            <Grid item container lg={12} justifyContent={'center'} mt={2}>
                <Grid item container lg={10} boxShadow={5} justifyContent={'space-between'} borderRadius={2}
                      bgcolor={'white.main'}>
                    <Grid item container lg={12} maxHeight={'50vh'} minHeight={'50vh'} boxShadow={1} justifyContent={'center'} overflow={'auto'} >
                        {ostan.map((item:any)=>(
                            <>
                                <Grid item container lg={10} xs={10}   bgcolor={'white.main'}
                                    ...
                                    <Grid item container lg={4} xs={12} justifyContent={'center'} mt={{lg: 2, xs: 2}} alignItems={"center"}>
                                        <Typography variant="h1" color={colors.yellow.main}> عنوان خبر  :  <span>{item.title?.slice(0,20)}</span> </Typography>
                                    </Grid>

                                    <Grid item container lg={4} xs={12} justifyContent={'center'} alignItems={"end"} mt={{xs: 2}}>
                                        <Grid item container lg={4} >
                                                <Typography sx={{cursor: "pointer"}} onClick={() => handleOpen(item)} variant="h1" color={colors.red.main}>ویرایش <span style={{color: colors.black.main}}></span></Typography>
                                        </Grid>
                                        <Grid item container lg={4}>
                                    ...
                                    <Grid item container m={0} mb={0} p={0} position={'relative'} lg={12}
                                        ...
                                        <List sx={{width: '100%'}}>
                                            <CSSTransition key={item.id} in={Id === item.id && opens} timeout={300} classNames="fade" unmountOnExit>
                                                <Grid item container justifyContent={'center'} lg={12} mt={2}
                                                      mb={0}>
                                                    <Grid item container lg={11}>
                                                            <Typography  variant={'caption'}  fontSize={'1rem'} textAlign={'justify'} >
