                                    ...
                                    {ostan?.map((item, index) => (
                                        <React.Fragment key={index}>
                                            ...
                                            >
                                                <Grid item container lg={4} xs={12} justifyContent={'center'}
                                                      mt={{lg: 2, xs: 2}} alignItems={"center"}>
                                                ...
                                                <Grid item container lg={4} xs={12}
                                                      justifyContent={'center'}
                                                      alignItems={"end"} mt={{xs: 2}}>
                                                    <Typography sx={{cursor: "pointer"}} onClick={() => handleAddFruit(item.id)} variant="h1" color={colors.red.main}>جزئیات
                                                        بیشتر <span style={{color: colors.black.main}}></span>
                                                    </Typography>
                                                    {Id === item.id && open ?
                                                        <KeyboardArrowDownIcon
                                                            sx={{color: 'kaarnas.yellow'}}/> :
                                        ...
                                        منتظر بررسی !
                                                                ...
                                                                <Grid item container p={2} lg={4} xs={6}
                                                                      justifyContent={'center'} alignItems={"center"}
                                                                      flexDirection={"column"}>
                                                                    <MTButton onClick={() => handleOpen(item.id)}
                                                                              submite
                                                                              sx={{color: 'white.main'}}>حذف
                                                                        شکایت</MTButton>
                                                                </Grid>
                                                            </Grid>
                                                        </CSSTransition>
