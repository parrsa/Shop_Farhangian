                    ...
                    <Grid item container lg={12}  justifyContent={{xs:'center' , lg:'center' , md:'start'}} >
                        ...
                        <Grid item container lg={11} borderRadius={3} minHeight={'55vh'} xs={11} justifyContent={{xs:'center'}}>
                                <Typography variant={'body1'} color={'black.main'} textAlign={'justify'}>
                                    شرکت تعاونی مصرف فرهنگیان در نظردارد جهت بهبود رفاه حال کارکنان برای خرید کالا به ارزش بیشتر از 50میلیون ریال تسهیلات ویژه ای اعطا نماید. این تسهیلات شامل بازپرداخت بدون سود طی مدت 24 ماه می باشد. مدارک لازم جهت دریافت تسهیلات فیش حقوقی و گواهی کسر از حقوق می باشد.
